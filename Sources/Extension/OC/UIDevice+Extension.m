...
+ (NSString *)al_ipv4 {
    ...
    NSDictionary *ipList = [UIDevice al_ipList];
    [@[@"en0/ipv4", @"pdp_ip0/ipv4"] enumerateObjectsUsingBlock:^(id  _Nonnull obj,
                                                                  NSUInteger idx,
                                                                  BOOL * _Nonnull stop) {
        if (ipList[obj]) {
            address = ipList[obj];
...
+ (NSString *)al_ipv6 {
    __block NSString *address;
    NSDictionary *ipList = [UIDevice al_ipList];
    [@[@"en0/ipv6", @"pdp_ip0/ipv6"] enumerateObjectsUsingBlock:^(id  _Nonnull obj,
                                                                  NSUInteger idx,
                                                                  BOOL * _Nonnull stop) {
        if (ipList[obj]) {
            address = ipList[obj];
...
+ (NSDictionary <NSString *, NSString *> *)al_ipList {
